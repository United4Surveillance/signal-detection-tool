...
### Signal Line List
The Signal Line List tab displays cases for selected signals in a line list.
...
- `min_cases_signals` *(Scalar: Integer)* - Minimum number of cases for a signal to be included
