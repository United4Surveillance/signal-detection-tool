...
flexdashboard::valueBox(value = s_agg$cases[is.na(s_agg$category)], 
         caption = paste0("Number of ", params$disease," cases in the last ", params$number_of_time_units," time units. The time unit is ", params$time_unit, "."),
...
flexdashboard::valueBox(value = n_signals_time_unit,
  caption = paste0("Number of signals for ", params$disease, " in the last ",
    params$number_of_time_units, 
    " time units. The time unit is ", params$time_unit, "."),
