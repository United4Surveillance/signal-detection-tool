...
stringr::str_glue(
  ...
  "Using the {names(params$algo)} algorithm {sum(results_analysis$alarm)} signal{ifelse(sum(results_analysis$n_alarms) == 1, '', 's')} {ifelse(sum(results_analysis$n_alarms) == 1, ' was', ' were')} detected.")
```
