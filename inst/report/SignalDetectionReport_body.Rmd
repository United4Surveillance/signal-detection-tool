...
if (!is.null(params$signals_padded) & !is.null(params$signals_agg)) {
  ...
  signal_results <- get_signals(data_preprocessed, 
                                stratification = NULL,
  ...
  if (!is.null(params$strata)) {
    signal_results_stratified  <- get_signals(
      data_preprocessed, 
    ...
    signals_agg <- aggregate_signals(signal_results_stratified, 
                                     number_of_weeks = params$number_of_weeks)
  }
  ...
  if (grepl("glm", params$method)) {
    ...
    signals_padded <- pad_signals(data_preprocessed,
                                  signal_results)
  }
