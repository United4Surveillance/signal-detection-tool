...
date: "Report generated on `r lubridate::stamp('28 April 2022', locale = ifelse('en_GB' %in% system('locale -a', intern = TRUE), 'en', Sys.getlocale('LC_TIME')), orders = 'dmy')(Sys.Date())`"
lang: "en"
output: 
  html_document:
    includes:
