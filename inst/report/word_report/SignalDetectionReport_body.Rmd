...
- Length of signal detection period: `r params$number_of_time_units` time units
...
stringr::str_glue(
  "In the signal detection period - last {params$number_of_time_units} time units available in the data - ",
...
```{r}
#| fig.cap=paste0("Number of ", params$disease, " cases by time unit and signals, ", params$country),
#| out.width="100%"
