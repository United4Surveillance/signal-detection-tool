...
`r ifelse(params$filter_outbreak_cases == TRUE && grepl("glm", params$method), paste0("- Only cases not associated with outbreaks are used for training and testing"), paste0(""))`
...
if (!is.null(params$signals_padded) & !is.null(params$signals_agg)) {
  ...
  signal_results <- SignalDetectionTool::get_signals(data_preprocessed,
    ...
    filter_outbreak_cases = params$filter_outbreak_cases
  )
