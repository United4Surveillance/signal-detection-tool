...
#' @param signals_agg tibble, aggregated signals which can be obtained from using the function aggregate_signals(). It contains the number of cases, any_alarms and n_alarms for one category, i.e. age group summed over the number of weeks used in aggregate_signals().
