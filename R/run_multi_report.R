#' Renders signal detection report with multiple pathogens
#'
...
#' @param signals_padded List of calculated and padded signals, each element corresponding to one pathogen (for use within the app, default is NULL)
#' @param signals_agg List of aggregated signals, each element corresponding to one pathogen (for use within the app, default is NULL)
...
run_multi_report <- function(
  ...
  # selecting pathogens from argument
  # TODO: assert pathogens exist in dataframe or padded signals
  checkmate::assert(
